...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-cash-coin me-2 text-primary"></i>Informacion de la Cuenta</h5>
    </div>
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-4 col-6">
                <small class="text-muted d-block">Cliente:</small>
                <span><?php echo $cuenta['cliente_nombre']; ?></span>
            </div>
            <div class="col-md-4 col-6">
                <small class="text-muted d-block">Cedula:</small>
                <span><?php echo $cuenta['cliente_cedula']; ?></span>
            </div>
            <div class="col-md-4 col-6">
            ...
            <?php if (!empty($cuenta['nota_fecha'])): ?>
            <div class="col-md-4 col-6">
                <small class="text-muted d-block">Fecha de Entrega:</small>
                <span><?php echo $cuenta['nota_fecha']; ?></span>
            </div>
            <?php endif; ?>
            <div class="col-12">
                <small class="text-muted d-block">Estado:</small>
                <span class="badge <?php echo $cuenta['estado'] === 'pagado' ? 'bg-success' : ($cuenta['estado'] === 'moroso' ? 'bg-danger' : 'bg-warning text-dark'); ?>">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-clock-history me-2 text-primary"></i>Historial de Pagos</h5>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formularioPago">
                <div class="modal-body">
                    <input type="hidden" id="cuentaId" value="<?php echo $cuenta['id_cuenta_cobrar']; ?>">
...
<script>
// Cargar tipos de pago y bancos
fetch('/SP%20Perfect%20Color/cuentaCobrar/obtenerDatosPagoAjax')
...
// Mostrar/ocultar banco y referencia segun tipo de pago
