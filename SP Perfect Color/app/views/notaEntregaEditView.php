...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <h2 class="h4 mb-0">Editar Nota de Entrega #<?php echo $nota['id']; ?></h2>
    <a href="/SP%20Perfect%20Color/notaEntrega/ver?id=<?php echo $nota['id']; ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Volver</a>
</div>
...
<form id="formularioEditarNota">
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-4">
                    ...
                    <span><?php echo ucfirst($nota['tipo_pago'] ?? '-'); ?></span>
                </div>
                <div class="col-md-4">
                    <small class="text-muted d-block">Metodo de Pago:</small>
                    <span><?php echo $nota['metodo_pago'] ?? '-'; ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                <label for="busquedaInsumoEdit" class="form-label">Buscar Insumo</label>
                <input type="text" id="busquedaInsumoEdit" class="form-control" placeholder="Buscar por nombre o codigo...">
            </div>
            <div id="listaInsumosEdit" class="list-group" style="max-height: 250px; overflow-y: auto;">
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="/SP%20Perfect%20Color/notaEntrega/ver?id=<?php echo $nota['id']; ?>" class="btn btn-outline-secondary"><i class="bi bi-x-lg me-1"></i>Cancelar</a>
