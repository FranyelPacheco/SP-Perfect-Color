...
<div class="d-flex justify-content-end gap-2 mt-4">
    <button class="btn btn-warning" onclick="cambiarEstado(<?php echo $nota['id']; ?>, 'en_espera')"><i class="bi bi-pause-circle me-1"></i>Poner en Espera</button>
</div>
<?php elseif ($nota['estado'] === 'en_espera'): ?>
<div class="d-flex justify-content-end gap-2 mt-4">
    <a href="/SP%20Perfect%20Color/notaEntrega/editar?id=<?php echo $nota['id']; ?>" class="btn btn-primary"><i class="bi bi-pencil me-1"></i>Editar Items</a>
    <button class="btn btn-success" onclick="cambiarEstado(<?php echo $nota['id']; ?>, 'entregado')"><i class="bi bi-check-lg me-1"></i>Marcar como Entregado</button>
</div>
<?php endif; ?>
